...
final +='== Description ==';
final +='\n';
final +='This is the long description.  No limit, and you can use Markdown (as well as in the following sections).';
final +='\n';
final +='For backwards compatibility, if this section is missing, the full length of the short description will be used, and Markdown parsed.';
final +='\n';
final +='A few notes about the sections above:';
final +='\n';
final +='*   "Contributors" is a comma separated list of wordpress.org usernames';
final +='*   "Tags" is a comma separated list of tags that apply to the plugin';
final +='*   "Requires at least" is the lowest version that the plugin will work on';
final +='// *   "Tested up to" is the highest version that youve *successfully used to test the plugin*. Note that it might work on';
